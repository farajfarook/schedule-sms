...
public class TemplateItem {
    ...
    public static List<TemplateItem> fetchTemplateItems(Context context){
        ...
        templateItems.add(new TemplateItem("Happy birthday", "Happy Birthday!!! I hope this is the beginning of your greatest, most wonderful year ever!"));
        ...
        templateItems.add(new TemplateItem("Mother’s Day", "Once upon a memory, Someone wiped away a tear, Held me close and loved me, Thank you, dear Mother."));
        templateItems.add(new TemplateItem("Good morning", "The Dream is not what you see in sleep, Dream is the thing which does not let you sleep. Good morning"));
